"""Recent-slice cancer index reader (offline workbook fixture)."""
...
from strata_platform.sources.nice_index import detect_ta_col, recent_cancer_tas
...
def test_recent_slice_filters_and_types() -> None:
    ...
    assert by_id["TA1000"].categorisation == "optimised"
